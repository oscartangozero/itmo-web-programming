...
<img src="img/area.png" alt="Вариант 32657v" style="float:right;max-width:50%;" title="Вариант 32657" align="right">
...
6. Таблицу с результатами предыдущих проверок. Список результатов должен браться из **HTTP-сессии** или Bean-компонента в зависимости от варианта.
